...
export default function ChangePassword() {
    ...
    return (
        <article>
            ...
            <h1 className="text-2xl font-bold mb-4">{translations[lang]["change_language"]}</h1>
            <form className="flex flex-col w-full" onSubmit={handleSubmit}>
                <div className="flex flex-row">
                    <div className="flex w-full sm:w-2/3 md:w-1/2 flex-col gap-4">
                        <Select onChange={(e) => { setLang(e.target.value); localStorage.setItem("lang", e.target.value); }}>
