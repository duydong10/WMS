        ...
        <Navbar fluid rounded>
          ...
          >
            ...
            >
              ...
              <DropdownDivider />
              <DropdownItem href="/change_password" icon={FaUserLock}>
                Change Password
              </DropdownItem>
              ...
              <button
                type="button"
                className="flex w-full cursor-pointer items-center justify-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white lg:hidden"
              >
              ...
              <div className="lg:hidden flex flex-col">
                {show && (
                  <div className="flex flex-col pl-1">
                    <DropdownItem href="/create_task" icon={RiArrowRightSFill}>
                      Create Task
                    </DropdownItem>
                    <DropdownItem
                      href="/continue_task"
                    ...
                    <DropdownItem href="/cancel_task" icon={RiArrowRightSFill}>
                      Cancel Task
                    </DropdownItem>
                    <DropdownItem href="/agv_callback" icon={RiArrowRightSFill}>
                      AGV Callback
                    </DropdownItem>
                  </div>
                )}
