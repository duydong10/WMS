    ...
    return (
        <ThemeProvider theme={MenuTheme}>
            <ListGroup className="min-h-screen">
                ...
                {showInbound && (
                    <>
                        <ListGroupItem><p className="list-inside">PO</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">ASN</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Receive By Scan</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Quality Check</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Cancel Receiving</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">ASN Group</p></ListGroupItem>
                ...
                {showInventory && (
                    <>
                        <ListGroupItem><p className="list-inside">Inventory Balance</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Transaction Log</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Hold/Release Document</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Transfer Document</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Movement Document</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Inventory Scan</p></ListGroupItem>
                        <ListGroupItem><p className="list-inside">Inventory Transfer</p></ListGroupItem>
                    </>
                )}
