...
export async function fetchLogin(data) {
    const res = await fetch("http://192.168.68.103:5000/login", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function fetchCancelTask(data) {
    const res = await fetchWithAuth("http://192.168.68.103:5000/agv/cancel_task", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${localStorage.getItem("jwtToken")}`,
...
export async function fetchAgvCallback(data) {
    const res = await fetchWithAuth("http://192.168.68.103:5000/agv/agv_callback", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${localStorage.getItem("jwtToken")}`,
...
export async function fetchContinueTask(data) {
    const res = await fetchWithAuth("http://192.168.68.103:5000/agv/continue_task", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${localStorage.getItem("jwtToken")}`,
